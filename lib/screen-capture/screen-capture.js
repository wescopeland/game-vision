...
var ScreenCapture = /** @class */ (function () {
    ...
    ScreenCapture.prototype.initializeImage = function (processes, gameResolution) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this._processId) return [3 /*break*/, 2];
                        _a = this;
    ...
    ScreenCapture.prototype.captureWindow = function (windowId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var pngPath = _this.generatePngPath();
            var cmd = "screencapture -x -o -l " + windowId + " " + pngPath;
    ...
    ScreenCapture.prototype.readBuffer = function (buffer) {
        ...
        return new Promise(function (resolve, reject) {
            Jimp.read(buffer)
                .then(function (image) {
                if (os_1.platform() === "darwin") {
                    image = _this._removeMacWindowTitle(image);
                }
                resolve(image);
            })
                .catch(function (err) {
    ...
    ScreenCapture.prototype._removeMacWindowTitle = function (image) {
