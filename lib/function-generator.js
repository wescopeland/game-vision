    ...
    GameVisionFunctionGenerator.prototype.generateActivate = function (watchingIntervalMs, thinkingIntervalMs, gameResolution) {
        ...
        var activate = function () {
            return __awaiter(this, void 0, void 0, function () {
                var currentImage, isDebouncing, isThinking, lastReadLifeCount, lastReadScore, didLifeCountIncrease, livesRemaining, isShowingHowHighText, currentScore, currentLevelIndicatorValue, tileImages;
                var _this = this;
                            ...
                            if (!that._isManualTrigger) {
                                setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                if (!!this._isThinking) return [3 /*break*/, 4];
                                            ...
                                            case 3:
                                                ...
                                                Promise.all(initializerPromises).then(function (_a) {
                                                    ...
                                                    if (isShowingTriggerText && !_this._isDebouncing) {
                                                        _this._isThinking = true;
                                ...
                                process.stdin.on("data", function (key) { return __awaiter(_this, void 0, void 0, function () {
                                    var promises;
                                    var _this = this;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                if (!key.includes("b")) return [3 /*break*/, 2];
                                                return [4 /*yield*/, this.captureEngine.initializeImage(this.processes, gameResolution)];
                                            case 1:
                                                currentImage = _a.sent();
                                                promises = [];
